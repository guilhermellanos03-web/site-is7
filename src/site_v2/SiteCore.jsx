...
// Versao leve do print, pros CARDS (720px, gerada por tools/gera-thumbs.js).
// O arquivo original tem 1600px porque o lightbox precisa: la a pessoa le o
// site inteiro. Nos cards ele aparece com uns 350px, entao carregar o grande
// significava baixar 4x mais pixel do que usar — a home pesava 2,2 MB, quase
// tudo nesses prints.
// Se a thumb nao existir (print novo sem rodar o script), o onErroThumb
// devolve o original em vez de deixar o card vazio.
const thumb = (src) => (src || "").replace("assets/portfolio/", "assets/portfolio/card/");
const onErroThumb = (e) => {
  const el = e.currentTarget;
  if (el.dataset.voltou) return;
  el.dataset.voltou = "1";
  el.src = el.src.replace("/assets/portfolio/card/", "/assets/portfolio/");
};
...
window.IS7v2 = { Icon, Logo, Eyebrow, Reveal, useCountUp, StatNumber, thumb, onErroThumb, WAPP, wa };
